...
class Pajama : GameCharacter {
    ...
    var pajamaColor: PajamaColor = PajamaColor.none {
        didSet {
            setColorFromPajamaColor(pajamaColor)
        }
    }
    
    init(pajamaColor: PajamaColor) {
        ...
        self.setColorFromPajamaColor(pajamaColor)
    }
    ...
    func setColorFromPajamaColor(pajamaColor: PajamaColor) {
        switch pajamaColor {
        case .none:
            self.color = UIColor.whiteColor()
        case .red:
